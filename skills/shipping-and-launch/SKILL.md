...
description: Prepare production launches with checklists, monitoring, staged rollout, and rollback strategies. Use before any significant deployment. Do NOT use for local development.
version: 1.0.0
license: MIT
compatibility: all
